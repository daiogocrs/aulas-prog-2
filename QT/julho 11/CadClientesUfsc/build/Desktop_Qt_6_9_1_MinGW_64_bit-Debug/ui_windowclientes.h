...
public:
    ...
    void setupUi(QMainWindow *WindowClientes)
    {
        ...
        button_salvar = new QPushButton(centralwidget);
        button_salvar->setObjectName("button_salvar");
        button_salvar->setGeometry(QRect(210, 130, 93, 29));
    ...
    void retranslateUi(QMainWindow *WindowClientes)
    {
        ...
        button_salvar->setText(QCoreApplication::translate("WindowClientes", "Salvar", nullptr));
